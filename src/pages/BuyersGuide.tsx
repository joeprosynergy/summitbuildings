  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Your 5-step roadmap to the perfect portable building. Learn how to choose the right size, materials, prepare your site, and more." />
      </Helmet>
      <Header />
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-black uppercase leading-[0.9]">
                    PORTABLE<br />BUILDING<br /><span className="text-secondary">BUYER'S</span><br />GUIDE
                  </h1>
            ...
            <div className="w-full max-w-4xl bg-background shadow-2xl mb-10 overflow-hidden">
              <div className="p-8 md:p-12 flex flex-col min-h-[700px]">
                ...
                <div className="flex gap-5 mb-7">
                  <div className="bg-secondary text-secondary-foreground w-11 h-11 min-w-[44px] flex items-center justify-center rounded-full font-black text-lg">1</div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-5">
                  <img src="https://shedsunlimited.b-cdn.net/wp-content/uploads/blog/10-Backyard-Portable-Buildings-For-Sale-in-2021/backyard-portable-buildings-for-sale-14x30-Premier-Garden-Shed-2-1400x933.jpg" alt="Spacious backyard workshop shed" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://www.lappstructures.com/wp-content/uploads/2024/12/20200814_111531_05344-1-scaled-aspect-ratio-570-400-1024x719.jpg" alt="Custom interior workshop" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://www.lappstructures.com/wp-content/uploads/2024/12/20210527_132818_01183-scaled-aspect-ratio-570-400-1024x718.jpg" alt="Organized home office or hobby space inside portable building" className="w-full h-auto rounded-lg shadow-md" />
                </div>
          ...
          {activePage === 3 && (
            <div className="w-full max-w-4xl bg-background shadow-2xl mb-10 overflow-hidden">
              <div className="p-8 md:p-12 flex flex-col min-h-[700px]">
                ...
                <div className="flex gap-5 mb-7">
                  <div className="bg-secondary text-secondary-foreground w-11 h-11 min-w-[44px] flex items-center justify-center rounded-full font-black text-lg">2</div>
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed mt-4">
                      Customize colors, rooflines, doors, and windows to match your home perfectly.
                    </p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-5">
                  <img src="https://countrysidebarns.com/site/wp-content/uploads/2018/11/12x20-Portable-Side-Porch-Cabin-Shed-Outdoor-Storage-Countryside-Barns-Building-e1633447571173.jpg" alt="Elegant side porch cabin style portable building" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://hartvilleoutdoorproducts.com/wp-content/uploads/2024/01/outdoor-shed-with-garage-door-Akron-ohio-2000x1500.webp" alt="Modern gable shed with garage door" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://images.ctfassets.net/89s5b832f23c/eHzRp0Gsh70f5qnXYgPN5/a9fe19e2767cff803560fa75da07016e/RT1dw_10x12_Craftsman_Steep_Pitch_Dormer_Transom_Cedar_Shake_Custom_Painted_Shed__1_.jpg?fm=webp&w=2560&h=1440" alt="Close-up of LP SmartSide siding on premium shed" className="w-full h-auto rounded-lg shadow-md" />
                </div>
          ...
          {activePage === 4 && (
            <div className="w-full max-w-4xl bg-background shadow-2xl mb-10 overflow-hidden">
              <div className="p-8 md:p-12 flex flex-col min-h-[700px]">
                ...
                <div className="flex gap-5 mb-7">
                  <div className="bg-secondary text-secondary-foreground w-11 h-11 min-w-[44px] flex items-center justify-center rounded-full font-black text-lg">3</div>
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed mt-4"><strong>Site Requirements:</strong></p>
                    ...
                    <p className="text-foreground/80 leading-relaxed mt-4"><strong>Warranty Notes:</strong></p>
                    <ul className="list-disc pl-5 my-3 text-foreground/80 text-sm leading-relaxed space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-5">
                  <img src="https://shedsunlimited.b-cdn.net/wp-content/uploads/landing-pages/How-to-Prepare-Your-Gravel-Shed-Pad/gravel-shed-pad-6-1400x933.jpg" alt="Compacted gravel pad with shed" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://goldstarbuildings.b-cdn.net/wp-content/uploads/concrete-blocks-for-portable-cabin-foundations-for-cabins-with-metal-roofs-in-erie-pa-768x512.jpg" alt="Concrete blocks under portable building" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://www.beachybarns.com/wp-content/uploads/bis-images/14355/concrete-pad-shed-foundations-for-backyard-buildings-in-urbana-oh-1600x9999.jpg" alt="Level foundation options for sheds" className="w-full h-auto rounded-lg shadow-md" />
                </div>
          ...
          {activePage === 5 && (
            <div className="w-full max-w-4xl bg-background shadow-2xl mb-10 overflow-hidden">
              <div className="p-8 md:p-12 flex flex-col min-h-[700px]">
                ...
                <div className="flex gap-5 mb-7">
                  <div className="bg-secondary text-secondary-foreground w-11 h-11 min-w-[44px] flex items-center justify-center rounded-full font-black text-lg">4</div>
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed mt-4">
                      Enjoy free delivery and setup within 50 miles. Custom orders typically ready in 10–30 days.
                    </p>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-5">
                  <img src="https://www.horizonstructures.com/wp-content/uploads/2014/11/muledelivery.jpg" alt="Shed Mule delivering building in tight space" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://i.ytimg.com/vi/F6vmI-eei9k/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBJOhYBvxxF7EgEM5K-_EFTaOqYOw" alt="Mule placing tall barn on site" className="w-full h-auto rounded-lg shadow-md" />
                  <img src="https://www.durastorstructures.com/wp-content/uploads/2025/03/delivery-2.png" alt="Professional portable building placement" className="w-full h-auto rounded-lg shadow-md" />
                </div>
          ...
          {activePage === 6 && (
            <div className="w-full max-w-4xl bg-background shadow-2xl mb-10 overflow-hidden">
              <div className="p-8 md:p-12 flex flex-col min-h-[700px]">
                ...
                <div className="flex gap-5 mb-7">
                  <div className="bg-secondary text-secondary-foreground w-11 h-11 min-w-[44px] flex items-center justify-center rounded-full font-black text-lg">5</div>
                  <div>
                    ...
                    <p className="text-foreground/80 leading-relaxed mt-4">
                      With proper care, your Summit structure will serve beautifully for decades.
                    </p>
                  </div>
                </div>
